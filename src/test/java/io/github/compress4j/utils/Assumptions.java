...
public class Assumptions {
    private static final boolean IS_SYM_LINK_CREATION_SUPPORTED = SystemUtils.IS_OS_UNIX || canCreateSymlinks();
    ...
    public static void assumeSymLinkCreationIsSupported() {
        assumeTrue(IS_SYM_LINK_CREATION_SUPPORTED, "Can't create symlinks on " + getOsNameAndVersion());
    }
}
