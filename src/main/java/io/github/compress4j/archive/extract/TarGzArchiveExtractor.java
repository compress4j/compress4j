 ...
 * @since 2.2
 */
public class TarGzArchiveExtractor extends TarBaseArchiveExtractor {

    /**
     * Creates a new {@code TarGzArchiveExtractor}
     *
     ...
     */
    public TarGzArchiveExtractor(TarGzArchiveInputStreamBuilder builder) throws IOException {
        super(builder);
    }
}
