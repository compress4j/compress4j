 ...
 * @since 2.2
 */
public class TarArchiveExtractor extends TarBaseArchiveExtractor {

    /**
     * Creates a new {@code TarArchiveExtractor}
     *
     ...
     */
    public TarArchiveExtractor(TarArchiveInputStreamBuilder builder) throws IOException {
        super(builder);
    }
}
