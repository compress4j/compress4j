...
public class TarGzDecompressor extends TarBaseDecompressor<TarGzDecompressor, TarGzDecompressor.Builder> {
    ...
    /**
     * Creates a new {@code TarGzDecompressor} with the given {@code Builder}
     *
     * @param builder the {@code Builder} to build the {@code TarGzDecompressor}
     */
     ...
     * @return a new {@code TarGzDecompressor.Builder}
     */
    ...
    /** Builder for {@code TarGzDecompressor} */
    public static final class Builder
            extends TarBaseDecompressor.Builder<TarGzDecompressor, TarGzDecompressor.Builder> {

        /**
         * Creates a new {@code TarGzDecompressor.Builder} with the given {@code Path}
         *
         * @param path the {@code Path} to the tar file
         * @throws IOException if an I/O error occurs
         */
        ...
        /**
         * Creates a new {@code TarGzDecompressor.Builder} with the given {@code InputStream}
         *
         * @param stream the {@code InputStream} to the tar file
         */
