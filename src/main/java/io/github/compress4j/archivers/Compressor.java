...
public interface Compressor {
    ...
    /**
     * Compresses the given input file to the given destination directory or file. <br>
    ...
    /**
     * Decompresses the given source file to the given destination directory or file. <br>
     * Requires the source the be an existing and readable File, and the destination to be either a file or a directory.
     ...
     * @return a stream that decompresses the data on the fly.
