...
public class DeflateDecompressor extends Decompressor<DeflateCompressorInputStream> {
    ...
    public static class DeflateDecompressorInputStreamBuilder<P> {
        private final P parent;
        private final InputStream inputStream;
        private boolean withZlibHeader = true;

        public DeflateDecompressorInputStreamBuilder(P parent, InputStream inputStream) {
            this.parent = parent;
            this.inputStream = inputStream;
        }

        public DeflateDecompressorInputStreamBuilder<P> setWithZlibHeader(boolean withZlibHeader) {
    ...
    public static class DeflateDecompressorBuilder
        ...
        private final DeflateDecompressorInputStreamBuilder<DeflateDecompressorBuilder> inputStreamBuilder;
        ...
        @Override
        public DeflateCompressorInputStream buildCompressorInputStream() throws IOException {
