...
/**
 * This class provides a Deflate decompressor that reads from a DeflateCompressorInputStream. It extends the
 * Decompressor class and provides a builder for creating instances.
 *
 * @since 2.2
 */
