...
/**
 * This abstract class is the superclass of all classes providing data compression functionality.
 * It provides core methods for compressing data to various output streams.
 *
