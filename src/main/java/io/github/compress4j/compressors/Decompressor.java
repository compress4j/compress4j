...
/**
 * This abstract class is the superclass of all classes providing data decompression functionality.
 * It provides core methods for decompressing data from various input streams.
 *
