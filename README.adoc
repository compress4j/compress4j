...
Extracting an archive you do not trust? Turn on the guards — see link:.github/SECURITY.md[SECURITY.md]:
...
See link:.github/CONTRIBUTING.adoc[CONTRIBUTING.adoc]. Commit subjects and pull request titles follow
